...
public class MedicineController {
    ...
    @GetMapping()
    public ResponseEntity<List<MedicineResponseDto>> listAllMedicine(Authentication authentication) {
        Long userId = Long.valueOf(authentication.getName());
        return ResponseEntity.status(HttpStatus.OK).body(medicineService.listAllMedicine(userId));
    }
